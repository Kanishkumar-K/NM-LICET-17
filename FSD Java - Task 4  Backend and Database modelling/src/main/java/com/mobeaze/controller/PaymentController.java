...
import com.mobeaze.exception.OrderException;
import com.mobeaze.exception.UserException;
import com.mobeaze.modal.Order;
import com.mobeaze.modal.User;
import com.mobeaze.repository.OrderRepository;
import com.mobeaze.response.ApiResponse;
import com.mobeaze.response.PaymentLinkResponse;
import com.mobeaze.service.OrderService;
import com.mobeaze.service.UserService;
import com.mobeaze.user.domain.OrderStatus;
import com.mobeaze.user.domain.PaymentStatus;
...
//		      paymentLinkRequest.put("reference_id",order.getId().toString());
		      ...
		      paymentLinkRequest.put("callback_url","https://shopwithmobeaze.vercel.app/payment/"+orderId);
...
//			order.setOrderItems(order.getOrderItems());
		...
		new RedirectView("https://shopwithmobeaze.vercel.app/payment/failed");
		throw new RazorpayException(e.getMessage());
	}
